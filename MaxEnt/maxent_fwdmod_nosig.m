%% This is the correct forward model A matrix for maxent by 17th Feb 2017
% y is generated by ideal pixelated image, NO Rx signal. But improved
% forward model, so better accuracy and no calibration needed
function maxent_fwdmod_nosig()
